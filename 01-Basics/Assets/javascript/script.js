        ...
        document.write(`<p>x = ${x}</p>`);//var keyword work as global
        //document.write(`<p>y = ${y}</p>`);
        //document.write(`<p>z = ${z}</p><hr>`);
        ...
        var title = "Welcome to js";//*string and charecter =>string
        ...
        //function behaviours
        //function (params)
        function defaltFun()//function declaration
        {
          document.write(`<p>this is default Function</p>`);
        }
        defaltFun();//function callings
